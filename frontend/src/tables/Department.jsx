    ...
    render() {
        return (
            <BootstrapTable data={ jobs }
                            ...
                            hover
                            >
                <TableHeaderColumn dataField='id' dataAlign='center' dataSort isKey hidden autoValue>Job ID</TableHeaderColumn>

                <TableHeaderColumn dataField='name' dataSort dataFormat={ priorityFormatter }
                                   editable={ {
                                       type: 'select',
                                       options: { values: [ 'CAL', 'Engineering', 'English', 'Math' ] },
                                       validator: priorityValidator } }>College</TableHeaderColumn>
                <TableHeaderColumn dataField='priority' dataSort dataFormat={ priorityFormatter }
                                   editable={ {
                                       type: 'select',
                                       options: { values: [ 'LS', 'Comm', 'LMC', 'E-Learning' ] },
                                       validator: priorityValidator } }>Department Name</TableHeaderColumn>
